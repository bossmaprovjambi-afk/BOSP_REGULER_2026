...
async function AmbilDataBospJambi() {
  try {
    ...
    // Membaca data mulai dari baris ke-3 (indeks 2) untuk melewati judul kolom atas spreadsheet
    for (let i = 2; i < lines.length; i++) {
      ...
      // VALIDASI DIPELONGGAR: Cukup pastikan kolom Nama Sekolah (indeks 2) tidak kosong agar semua terdata
      if (col && col[2]) {
        totalSekolahCount++;
    ...
    // Suntikkan Angka Kumulatif Akhir yang Sudah Pas ke Dasbor Atas
